package com.nainesh.org.Messanger.service;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import com.nainesh.org.Messanger.database.DatabaseClass;
...
public class MessageService {
	...
	public Message getMessage(long iid) {
		return messages.get(iid);
	}
